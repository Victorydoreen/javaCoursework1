...
// public class Main { //the mother class that contains all the methods of system
...
//     static {
//         schools.add(new School("School A", "City X", 4.5));//schools to be recommend
//         schools.add(new School("School B", "City Y", 4.2));
//         schools.add(new School("School C", "City Z", 4.8));
//     }
...
//         // Create some sample users (mock data for demonstration)
...
//                     break;
//                 case 7:
//                     claimScholarlyMaterials(user); // Pass the user object
//                     break;
//                 case 8:
...
//         System.out.println("7. Claim Scholarly Material");
...
//         System.out.println("2. Scholarly Materials");
...
//     //SCHOLAR MATERIALS
//     private static void claimScholarlyMaterials(User user) {
//         System.out.println("\nClaim Scholarly Materials");

//         List<String> scholarlyMaterials = getScholarlyMaterials();

//         System.out.println("Available Scholarly Materials for " + user.getUsername() + ":");
//         for (int i = 0; i < scholarlyMaterials.size(); i++) {
//             System.out.println((i + 1) + ". " + scholarlyMaterials.get(i));
//         }

//         System.out.print("Enter the number of the scholarly material you want to claim: ");
//         int scholarlyMaterialChoice = scanner.nextInt();
//         scanner.nextLine(); // Consume the newline character

//         if (scholarlyMaterialChoice >= 1 && scholarlyMaterialChoice <= scholarlyMaterials.size()) {
//             String selectedScholarlyMaterial = scholarlyMaterials.get(scholarlyMaterialChoice - 1);
//             System.out.println("Selected Scholarly Material: " + selectedScholarlyMaterial);
...
//             System.out.print("Enter the number of the scholarship you want to claim the scholarly material for: ");
//             int scholarshipIndex = scanner.nextInt();
//             scanner.nextLine(); // Consume the newline character
...
//                         // Call the displayScholarlyMaterialDetails method to show the details of the selected scholarly material
//                         displayScholarlyMaterialDetails(selectedScholarlyMaterial);
//                         // Now, call the claimScholarlyMaterial method from the User class
//                         user.claimScholarlyMaterial(selectedScholarship, selectedScholarlyMaterial);
//                     } else {
//                         System.out.println("You must apply for the selected scholarship before claiming this scholarly material.");
//                     }
//                 } else {
//                     System.out.println("You are not eligible to claim any scholarly materials.");
//                 }
//             } else {
//                 System.out.println("Invalid scholarship index. Please try again.");
//             }
//         } else {
//             System.out.println("Invalid scholarly material index. Please try again.");
//         }
//     }



//     private static List<String> getScholarlyMaterials() {
//         // Return a list of scholarly materials
//         List<String> scholarlyMaterials = new ArrayList<>();
//         scholarlyMaterials.add("Rotatrim");
//         scholarlyMaterials.add("Ruled Papers");
//         scholarlyMaterials.add("Toilet Tissues");
//         return scholarlyMaterials;
//     }

//     private static void displayScholarlyMaterialDetails(String scholarlyMaterial) {
//         System.out.println("Scholarly Material Details:");
...
//             System.out.println("Login successful as parent.");
//             return parent;
//         } else {
...
//     public void claimScholarlyMaterial(Scholarship scholarship, String scholarlyMaterial) {
//         if (claimedScholarships.containsKey(scholarlyMaterial)) {
//             System.out.println("You have already claimed " + scholarlyMaterial + " from this scholarship.");
//             return;
//         }

//         incrementProgress(); // Update user's progress
//         collectFeedback(scholarlyMaterial); // Add the material to the user's claimed scholarly materials

//         // Store the scholarship information
//         claimedScholarships.put(scholarlyMaterial, scholarship);

//         System.out.println("Claiming " + scholarlyMaterial + " for " + getUsername() + " from Scholarship: " + scholarship.getName() + " is Done!");
//     }
...
//     public void collectFeedback(String scholarlyMaterial) {
//         System.out.println("Collecting feedback for " + scholarlyMaterial + "...");
//     }
// }
